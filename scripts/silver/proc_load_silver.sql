...
SELECT
    ...
    CASE 
        WHEN bdate > GETDATE() OR bdate IS NULL THEN NULL
        ELSE bdate
    END AS bdate,
...
SELECT
    ...
    CASE
        WHEN UPPER(TRIM(TRANSLATE(cntry, CHAR(10) + CHAR(13), '  '))) = 'DE'
            THEN 'Germany'

        WHEN UPPER(TRIM(TRANSLATE(cntry, CHAR(10) + CHAR(13), '  ')))
             IN ('US', 'USA')
            THEN 'United States'

        WHEN cntry IS NULL
             OR TRIM(TRANSLATE(cntry, CHAR(10) + CHAR(13), '  ')) = ''
            THEN 'n/a'

        ELSE TRIM(TRANSLATE(cntry, CHAR(10) + CHAR(13), '  '))
    END AS cntry
